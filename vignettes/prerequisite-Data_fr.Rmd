...
on peut aussi se focaliser sur des scalaires, ie des colonnes specifiques (à l exception des colonnes Frames) du tableau avec la fonction `DescritiveScalarSequence`.
